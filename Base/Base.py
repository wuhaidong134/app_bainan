...
class Base:
    ...
    def get_element(self,loc,timeout=30,poll_frequency=1.0):
        """
        定位单个元素
        :parparam loc: (By.ID,id属性值) (By.CLASS_NAME,class属性值) (By.XPATH,xpath属性值)
    ...
    def get_elements(self,loc,timeout=30,poll_frequency=1.0):
        ...
        :return:
        """
        return WebDriverWait(self.driver,loc,timeout,poll_frequency).until(lambda x: x.find_elements(*loc))
